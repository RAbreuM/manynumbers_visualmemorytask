...
function mng_welcomeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of mng_welcomeComponents)
...
function mng_blankRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of mng_blankComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function mng_probeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of mng_probeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function mng_testRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of mng_testComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
